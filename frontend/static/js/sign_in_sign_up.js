    ...
    $.ajax({
        ...
        success: function(data) {
            if (data === "0") {
                ...
                var test = '<img id="c_photo" alt="40x40" src="'+img_src+'" onerror="this.src=\'/static/Unknown.png\'" class="img-circle" height="40" width="40" />';
            ...
            if (account === "") {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        console.log(data);
                        if (data === "400") {
                            document.getElementById("sign_up_info").innerHTML = "Account name exist!";
                            $("#sign_up_info_div").show(500);
                        } else {
                            document.getElementById("sign_up_cancel").click();
                        }
                    },
                    error: function (xhr, type) {
                        console.log(xhr,type);
