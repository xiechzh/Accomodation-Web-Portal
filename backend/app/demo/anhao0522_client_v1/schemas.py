...
validators = {
    ...
    ('accommodation_room_pid_comment', 'POST'): {'json': {'$ref': '#/definitions/Comment'}, 'headers': {'required': [], 'properties': {'auth_token': {'required': False, 'type': 'string'}}}, 'args': {'required': ['order_id'], 'properties': {'order_id': {'type': 'integer'}}}},
    ...
    ('landlord_lid_order', 'GET'): {'headers': {'required': [], 'properties': {'auth_token': {'required': False, 'type': 'string'}}}, 'args': {'required': ['order_id'], 'properties': {'order_id': {'type': 'integer'}}}},
    ('landlord_lid_order', 'DELETE'): {'headers': {'required': [], 'properties': {'auth_token': {'required': False, 'type': 'string'}}}, 'args': {'required': ['order_id', 'cancel_order'], 'properties': {'order_id': {'type': 'integer'}, 'cancel_order': {'type': 'boolean'}}}},
    ...
    ('user_uid_order', 'DELETE'): {'headers': {'required': [], 'properties': {'auth_token': {'required': False, 'type': 'string'}}}, 'args': {'required': ['order_id'], 'properties': {'order_id': {'type': 'integer'}}}},
}
...
filters = {
    ...
    ('messageBox', 'GET'): {200: {'headers': None, 'schema': {'type': 'array', 'items': {'$ref': '#/definitions/Customer'}}}, 400: {'headers': None, 'schema': None}, 401: {'headers': None, 'schema': None}},
    ...
    ('landlord_lid_order', 'GET'): {200: {'headers': None, 'schema': {'type': 'array', 'items': {'$ref': '#/definitions/Order'}}}, 400: {'headers': None, 'schema': None}, 401: {'headers': None, 'schema': None}, 404: {'headers': None, 'schema': None}},
    ('landlord_lid_order', 'DELETE'): {200: {'headers': None, 'schema': None}, 400: {'headers': None, 'schema': None}, 401: {'headers': None, 'schema': None}, 404: {'headers': None, 'schema': None}},
...
scopes = {
    ...
    ('landlord_lid_order', 'GET'): [],
    ('landlord_lid_order', 'DELETE'): [],
    ('user_uid', 'GET'): [],
    ('user_uid', 'PUT'): [],
    ('user_uid_order', 'GET'): [],
    ('user_uid_order', 'POST'): [],
